...
<div class="mega-panel mega-what" role="region" aria-label="<?php esc_attr_e( 'What we do', 'advay-theme' ); ?>">
	<div class="mega-col">
		...
		<div class="mega-col-links">
			<a href="<?php echo esc_url( advay_services_url( 'amazon' ) ); ?>">
			...
			<a href="<?php echo esc_url( advay_services_url( 'walmart' ) ); ?>">
				<span class="mega-dot" aria-hidden="true"></span>
				<span>
			...
			<a href="<?php echo esc_url( advay_services_url( 'tiktok' ) ); ?>">
				<span class="mega-dot" aria-hidden="true"></span>
				<span>
			...
			<a href="<?php echo esc_url( advay_services_url( 'dtc' ) ); ?>">
				<span class="mega-dot" aria-hidden="true"></span>
				<span>
	...
	<div class="mega-col">
		<a class="mega-head" href="<?php echo esc_url( advay_receiving_url() ); ?>">
			<span class="mega-ico mega-ico-sq" aria-hidden="true">
	...
	<div class="mega-col">
		<a class="mega-head" href="<?php echo esc_url( advay_onboarding_url() ); ?>">
			<span class="mega-ico mega-ico-sq" aria-hidden="true">
