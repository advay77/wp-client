...
function advay_success_stories_data() {
	...
	$stories = array(
		'no-knife-body' => array(
			...
			'founder'            => __( 'S. Greenlee', 'advay-theme' ),
			'founder_role'       => __( 'Founder, No Knife Body', 'advay-theme' ),
			...
			'founder_caption'    => __( 'S. Greenlee, Founder', 'advay-theme' ),
		...
		'ajayi-popcorn' => array(
			...
			'founder'            => __( 'Bolu Ajayi', 'advay-theme' ),
			...
			'founder_caption'    => __( 'Bolu Ajayi, Founder', 'advay-theme' ),
		...
		'daka-vitamins' => array(
			...
			'founder'            => __( 'Brian McNeill', 'advay-theme' ),
			...
			'founder_caption'    => __( 'Brian McNeill, Founder', 'advay-theme' ),
