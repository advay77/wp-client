	...
	acf_add_local_field_group(
		array(
			...
			'fields'                => array(
				...
				array(
					'key'   => 'field_advay_wwd_tab',
					'label' => 'What we do menu',
					'type'  => 'tab',
				),
				array(
					'key'   => 'field_advay_wwd_platforms_title',
					'label' => '[Column] Platforms — title',
					'name'  => 'wwd_platforms_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_platforms_desc',
					'label' => '[Column] Platforms — description',
					'name'  => 'wwd_platforms_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_platforms_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_platforms_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_amazon_title',
					'label' => '  - Amazon Ful. Services — title',
					'name'  => 'wwd_amazon_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_amazon_desc',
					'label' => '  - Amazon Ful. Services — description',
					'name'  => 'wwd_amazon_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_amazon_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_amazon_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				...
				array(
					'key'   => 'field_advay_wwd_walmart_title',
					'label' => '  - Walmart Ful. Services — title',
					'name'  => 'wwd_walmart_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_walmart_desc',
					'label' => '  - Walmart Ful. Services — description',
					'name'  => 'wwd_walmart_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_walmart_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_walmart_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_tiktok_title',
					'label' => '  - TikTok Shop Fulfilment — title',
					'name'  => 'wwd_tiktok_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_tiktok_desc',
					'label' => '  - TikTok Shop Fulfilment — description',
					'name'  => 'wwd_tiktok_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_tiktok_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_tiktok_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				...
				array(
					'key'   => 'field_advay_wwd_dtc_title',
					'label' => '  - DTC Fulfilment — title',
					'name'  => 'wwd_dtc_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_dtc_desc',
					'label' => '  - DTC Fulfilment — description',
					'name'  => 'wwd_dtc_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_dtc_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_dtc_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				...
				array(
					'key'   => 'field_advay_wwd_services_title',
					'label' => '[Column] Services — title',
					'name'  => 'wwd_services_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_services_desc',
					'label' => '[Column] Services — description',
					'name'  => 'wwd_services_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_services_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_services_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_receiving_title',
					'label' => '  - Receiving & Inspection — title',
					'name'  => 'wwd_receiving_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_receiving_desc',
					'label' => '  - Receiving & Inspection — description',
					'name'  => 'wwd_receiving_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_receiving_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_receiving_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_labeling_title',
					'label' => '  - Labeling & Prep — title',
					'name'  => 'wwd_labeling_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_labeling_desc',
					'label' => '  - Labeling & Prep — description',
					'name'  => 'wwd_labeling_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_labeling_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_labeling_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_kitting_title',
					'label' => '  - Packaging, Kitting, Rework — title',
					'name'  => 'wwd_kitting_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_kitting_desc',
					'label' => '  - Packaging, Kitting, Rework — description',
					'name'  => 'wwd_kitting_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_kitting_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_kitting_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_outbound_title',
					'label' => '  - Outbound & Shipping — title',
					'name'  => 'wwd_outbound_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_outbound_desc',
					'label' => '  - Outbound & Shipping — description',
					'name'  => 'wwd_outbound_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_outbound_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_outbound_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_returns_title',
					'label' => '  - Returns & Reverse Logistics — title',
					'name'  => 'wwd_returns_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_returns_desc',
					'label' => '  - Returns & Reverse Logistics — description',
					'name'  => 'wwd_returns_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_returns_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_returns_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_getstarted_title',
					'label' => '[Column] Get started — title',
					'name'  => 'wwd_getstarted_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_getstarted_desc',
					'label' => '[Column] Get started — description',
					'name'  => 'wwd_getstarted_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_getstarted_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_getstarted_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_pricing_title',
					'label' => '  - Pricing — title',
					'name'  => 'wwd_pricing_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_pricing_desc',
					'label' => '  - Pricing — description',
					'name'  => 'wwd_pricing_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_pricing_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_pricing_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
				array(
					'key'   => 'field_advay_wwd_onboarding_title',
					'label' => '  - One-click Onboarding — title',
					'name'  => 'wwd_onboarding_title',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_advay_wwd_onboarding_desc',
					'label' => '  - One-click Onboarding — description',
					'name'  => 'wwd_onboarding_desc',
					'type'  => 'text',
				),
				array(
					'key'          => 'field_advay_wwd_onboarding_url',
					'label'        => '  → link (leave empty for default)',
					'name'         => 'wwd_onboarding_url',
					'type'         => 'url',
					'instructions' => 'Where this menu item goes. Empty = the built-in page.',
				),
			),
